...
export const specialGames: { id: string; title: string; description: string; category: GameCategory; keywords?: string[] }[] = [
  ...
  // Classic senior-favorite games
  { id: "klondike-solitaire", title: "Solitaire", description: "The classic single-player card game — build the four foundations from Ace to King.", category: "memory-games", keywords: ["cards", "klondike", "patience", "deck", "classic"] },
  { id: "mahjong-solitaire", title: "Mahjong Solitaire", description: "Clear the stacked tiles by matching free pairs — the calming classic.", category: "memory-games", keywords: ["tiles", "matching", "shanghai", "mahjong", "pairs", "zen"] },
  { id: "bingo", title: "Bingo", description: "Mark called numbers on your card — first to complete a row, column, or diagonal wins!", category: "memory-games", keywords: ["numbers", "cards", "lucky", "classic", "daub"] },

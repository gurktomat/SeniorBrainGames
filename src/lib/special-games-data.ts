export const specialGamesMetadata: Record<string, Record<string, { title: string; description: string }>> = {
  "nostalgia-trivia": {
    ...
    "classic-hollywood-leading-ladies": { title: "Classic Hollywood Leading Ladies", description: "How well do you remember the silver screen's most iconic actresses? Audrey, Marilyn, and more!" },
    "greatest-crooners": { title: "Greatest Crooners of the 20th Century", description: "Golden voices of Frank Sinatra, Dean Martin, and the crooning era!" },
  },
  "general-knowledge": {
    ...
    "wonders-of-the-world": { title: "Wonders of the World", description: "How well do you know the world's most famous landmarks and ancient wonders?" },
  },
  "word-games": {
